...
export const POST: RequestHandler = async ({ request }) => {
	...
	const allowed = new Set(['album_art_disabled', 'registration_closed', 'invite_only', 'max_users', 'feed_scoped', 'spotify_enabled', 'youtube_music_enabled', 'apple_music_enabled', 'apple_music_dev_token']);
